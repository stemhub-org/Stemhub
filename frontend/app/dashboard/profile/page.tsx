    ...
    return (
        <div className="max-w-7xl mx-auto space-y-8 pb-12">
            ...
            <motion.div
                ...
                className="flex flex-col md:flex-row gap-8 items-start relative rounded-2xl border border-foreground/[0.08] bg-background-secondary p-8 backdrop-blur-xl"
            >
            ...
            <motion.div
                ...
                className="rounded-2xl border border-foreground/[0.08] bg-background-secondary p-6 backdrop-blur-xl"
            >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                >
                    ...
                    <div className="space-y-4">
                        {projects.slice(0, 3).map((project) => (
                            <div
                                key={project.id}
                                className="rounded-2xl border border-foreground/[0.08] bg-background-secondary p-6 hover:opacity-95 dark:hover:bg-background-secondary/60 transition-all cursor-pointer backdrop-blur-xl group"
                        ...
                        {projects.length === 0 && (
                            <div className="text-sm text-foreground/50 italic p-6 text-center border border-foreground/10 rounded-2xl bg-background-secondary">
                ...
                >
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex flex-col rounded-2xl border border-foreground/[0.08] bg-background-secondary p-5 backdrop-blur-xl hover:opacity-95 dark:hover:bg-background-secondary/60 transition-colors cursor-pointer" onClick={() => router.push("/dashboard")}>
